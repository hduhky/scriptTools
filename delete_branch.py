...
response = requests.get(branch_api_url, params={"search": search_query}, headers={"PRIVATE-TOKEN": access_token})
...
if response.status_code == 200:
    ...
    for branch_name in branch_names:
        delete_response = requests.delete(delete_branch_api_url + branch_name, headers={"PRIVATE-TOKEN": access_token})
