...
PRODUCT_CODE = u"GuardLive_iOS-B2101"
...
for root, dirs, files in os.walk(DESKTOP_PATH):
    ...
    for a_dir in dirs:
        ...
        if contains_str(a_dir, ADHOC_KEY):
            ...
            adhoc_file_path = os.path.join(adhoc_folder_path, u"Guard Live.ipa")
            ...
            app_file_path = os.path.join(app_folder_path, u"Guard Live.ipa")
